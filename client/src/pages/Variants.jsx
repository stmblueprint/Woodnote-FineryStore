                ...
                return (
                  ...
                  <div key={`${product.id}-${index}`}>
                    <div className="">
                      ...
                      <img
                        key={variant.id}
                        onClick={() => handleSelectedProduct(variant.preview_url)}
                        ...
                        style={{ 
                          ...
                          // hide product design
                          display: hideBrandLogo 
                          && variant.preview_url
                           === 'https://files.cdn.printful.com/files/a0c/a0cb89fac531110dd3215265eea0731e_preview.png'
                           || variant.preview_url === 'https://files.cdn.printful.com/printfile-preview/428032726/dfe0e3eb04707085d954e423c2ebdf97_preview.png'
                           || variant.preview_url === 'https://files.cdn.printful.com/printfile-preview/428032724/3dac38103c99fcf03be783ef15e45578_preview.png'
                           || variant.preview_url === 'https://files.cdn.printful.com/files/a94/a948da8512bf1ba199713b2b156a68fb_preview.png'
                           || variant.preview_url === 'https://files.cdn.printful.com/printfile-preview/580742011/fd78a2493d62133ac38488b52c1a4544_preview.png'
